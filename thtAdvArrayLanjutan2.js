...
/*
//Mencari location menggunakan for 
const locations=[];
for (const d of data){
...
/*
// cara memanggil satu satu
const storeLocations={
    Denver : data.filter((d)=>{
        return d.storeLocation == "Denver";

    }), 
    Seattle : data.filter((d)=>{
        return d.storeLocation=="Seattle";
    }), 
    London:data.filter((d)=>{
        return d.storeLocation=="London";
    }), 
    Austin :data.filter((d)=>{
        return d.storeLocation=="Austin";
    }), 
    'New York':data.filter((d)=>{
        return d.storeLocation == "New York";
    }), 
    "San Diego" :data.filter ((d)=>{
        return d.storeLocation == "San Diego";
    }),
}
...
console.log (locations);
// menggunganakan looping
let storeLocations = {}
for (const d of locations){
    storeLocations[d]=data.filter((_d)=>{
        return _d.storeLocation===d
