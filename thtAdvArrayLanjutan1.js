...
const dataBaru = data.map((data) => {
    const items =data.items.map(function(items1){
        return {
            name : items1.name,
...
for (const data of dataBaru) {
    console.log('==================================================');
    console.log("Menampilkan Data baru ")
    console.log('Id Transaction: ', data.idTransaction);
    console.log('Store Location: ', data.storeLocation);
    console.log('User Email: ', data.userEmail);
    console.log('Purchase Method: ', data.purchaseMethod);
    console.log('Items: ', data.items1);
    console.log('==================================================');
}